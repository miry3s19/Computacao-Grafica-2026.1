...
-[ ] b. O cenário deve ser construído a partir de primitivas geométricas: quadriláteros (cercas e canteiros), triângulos (folhagens) e círculos (vegetais ao fundo, sol);
...
-[ ] b. Quando o coelho colide com um vegetal, este deve desaparecer da tela;
